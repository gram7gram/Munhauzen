...
public class EnAuthorsFragment extends AuthorsFragment {
    ...
    protected Table createBody() {
        ...
        Image img3 = new FitImage(screen.assetManager.get("authors/author_3_1.png", Texture.class));
        Image img4 = new FitImage(screen.assetManager.get("authors/author_4_1.png", Texture.class));

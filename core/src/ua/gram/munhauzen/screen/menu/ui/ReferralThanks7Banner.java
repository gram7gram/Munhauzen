...
public class ReferralThanks7Banner extends Banner<MenuScreen> {

    final ReferalThanks7Fragment fragment;

    public ReferralThanks7Banner(ReferalThanks7Fragment fragment) {
    ...
    public Table createContent() {
        ...
        for (String sentence : screen.game.t("referral_banner_7.title").split("\n")) {
        ...
        PrimaryButton btn = screen.game.buttonBuilder.danger(screen.game.t("referral_banner_7.btn"), new ClickListener() {
            @Override

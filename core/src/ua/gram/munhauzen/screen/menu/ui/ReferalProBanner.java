...
public class ReferalProBanner extends Banner<MenuScreen> {

    final ReferalFragment fragment;

    public ReferalProBanner(ReferalFragment fragment) {
    ...
    public Table createContent() {
        ...
        for (String sentence : screen.game.t("referal_banner_pro.title").split("\n")) {
        ...
        Label label2 = new Label(screen.game.t("referal_banner.link"), style);

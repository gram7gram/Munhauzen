...
public class NewAchievementBanner extends Banner<MenuScreen> {

    final NewAchievementFragment fragment;

    public NewAchievementBanner(NewAchievementFragment fragment) {
    ...
    public Table createContent() {
        ...
        for (String sentence : screen.game.t("menu_achievement_banner.title").split("\n")) {
    ...
    private Actor getActionBtn() {
        ...
        return screen.game.buttonBuilder.danger(screen.game.t("menu_achievement_banner.btn"), new ClickListener() {
            @Override

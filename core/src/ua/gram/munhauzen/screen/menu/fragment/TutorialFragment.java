...
import ua.gram.munhauzen.screen.menu.ui.TutorialBanner;
import ua.gram.munhauzen.ui.FragmentRoot;
import ua.gram.munhauzen.utils.Log;

public class TutorialFragment extends MenuFragment {

    FragmentRoot root;
    public boolean isFadeIn;
    public boolean isFadeOut;

    public TutorialFragment(MenuScreen screen) {
        super(screen);
    }
    ...
    public void create() {
        ...
        screen.assetManager.load("menu/tutorial.png", Texture.class);

        screen.assetManager.finishLoading();

        TutorialBanner banner = new TutorialBanner(this);
        banner.create();

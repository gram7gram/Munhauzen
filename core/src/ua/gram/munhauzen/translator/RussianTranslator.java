...
public class RussianTranslator implements Translator {
    ...
    public RussianTranslator() {
        ...
        map.put("loading.title", "ЗагрСейчас начнеться скачивание необходимых файлов для игры. Пожалуйста, не прерывайте Wi-Fi соединения и дождитесь загрузки.узка ресурсов");
        map.put("loading.message", "");
        ...
        map.put("chapter_banner.btn", "Начать");

...
public class RussianTranslator implements Translator {
    ...
    public RussianTranslator() {
        ...
        map.put("authors.content1", "Дорогие слушатели!\nПриносим большую благодарность художнику");
        map.put("authors.link1", "Андрею Кулагину");
        map.put("authors.content2", "за его прекрасные и усердные работы лайнером, акварелью, рукой и головой. Его шедевры и безвозмездная увлечённость дарили нам вдохновение на протяжении всей работы.");
        ...
        map.put("authors.content9", "Выражаю искреннюю благодарность");
        map.put("authors.link3", "Илье Кошевому");
        map.put("authors.content10", "за написание музыки и помощи по всяким мелочам!");
        map.put("authors.content11", "Спасибо организатору!");
        map.put("authors.content12", "Ну и спасибо, конечно же, самому Распе!\nВеликолепно!");
    }

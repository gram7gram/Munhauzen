...
public class HireStoryScenario extends StoryMedia<HireStoryScenario> {

    final GameState gameState;
    public int duration;
    public HireScenario scenario;
    public HireStoryImage currentImage;
    public StoryAudio currentAudio;

    public HireStoryScenario(GameState gameState) {
    ...
    public void init() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            current.duration = audioDuration;
    ...
    public void update(float progress, int max) {
        ...
        if (scenario.images != null) {
            ...
            for (HireStoryImage item : scenario.images) {

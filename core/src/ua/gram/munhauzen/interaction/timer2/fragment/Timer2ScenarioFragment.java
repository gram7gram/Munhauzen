...
public class Timer2ScenarioFragment extends ScenarioFragment {

    private final Timer2Interaction interaction;

    public Timer2ScenarioFragment(GameScreen gameScreen, Timer2Interaction interaction) {
        super(gameScreen);
    ...
    public void makeDecision(final int currentIndex, Decision decision) {
        try {
            ...
            Timer2Story newStory = interaction.storyManager.create(decision.scenario);

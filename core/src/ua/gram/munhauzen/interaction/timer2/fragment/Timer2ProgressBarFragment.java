 ...
 */
public class Timer2ProgressBarFragment extends Fragment {
    ...
    public ImageButton rewindBackButton, rewindForwardButton, pauseButton, playButton, skipBackButton, skipForwardButton;

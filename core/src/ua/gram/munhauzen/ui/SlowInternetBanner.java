...
public class SlowInternetBanner extends Banner<MunhauzenScreen> {
    ...
    public SlowInternetBanner(BannerFragment<MunhauzenScreen> fragment, Runnable action) {
    ...
    public Table createContent() {
        ...
        Label title = new Label(screen.game.t("slow_internet_banner.title"), titleStyle);
        ...
        for (String sentence : screen.game.t("slow_internet_banner.content").split("\n")) {

...
public class VerticalScrollPane extends WidgetGroup {
    ...
    /**
     * THE ONLY DIFFERENCE FROM ScrollPane
     */
     ...
     * @param widget May be null.
     */
    public VerticalScrollPane(Actor widget, ScrollPaneStyle style) {
        ...
        addCaptureListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                getStage().setScrollFocus(VerticalScrollPane.this);
    ...
    /**
     * The style for a scroll pane, see {@link VerticalScrollPane}.
     *
     * @author mzechner
     * @author Nathan Sweet
     */
